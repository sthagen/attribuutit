...
2025.7.8
:    Added version command, published python >= py39 requirement, and then some ...

2022.8.1
:    Migrated upstream away from github and amended documentation
...
2022.6.30
:    Condensed output, refactored implementation, and extended tests
